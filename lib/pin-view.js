...
pinView.classList.add('tree-view-pin-container');

var pinViewButton = document.createElement('div');
pinViewButton.classList.add('tree-view-pin-button', 'icon', 'icon-pin');
pinView.appendChild(pinViewButton);
