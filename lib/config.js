...
const config = {
  ...
  autoFocusTreeView: {
    description: 'Automatically focus the tree view when it is opened. This allows keybindings to work right away. May fix an issue where the add and rename dialogs of the tree view don\'t work.',
    type: 'boolean',
    default: true,
    order: 10,
  },
