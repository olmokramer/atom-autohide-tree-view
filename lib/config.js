...
const config = {
  ...
  autoFocusTreeViewOnHover: {
    description: 'This setting is for people that are experiencing issues with the tree view dialogs for adding/renaming files, where the dialog flashes before going invisible.',
    type: 'boolean',
    default: true,
    order: 11,
  },
