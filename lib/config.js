...
export default {
  ...
  get showDelay() {
    return get('showDelay');
  },
  get hideDelay() {
    return get('hideDelay');
  },
  get minWidth() {
    return get('minWidth');
  },
  ...
  get pushEditor() {
    return get('pushEditor');
  },
  get triggerAreaSize() {
    return get('triggerAreaSize');
  },
  get touchAreaSize() {
    return get('touchAreaSize');
  },
  get maxwindowWidth() {
    return get('maxWindowWidth');
  },
  get showPinButton() {
    return get('showPinButton');
  },
  get showOnRightSize() {
    return get('showOnRightSide', 'tree-view');
  },
};

function get(key, ns = 'autohide-tree-view') {
