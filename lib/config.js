...
const config = {
  ...
  autoFocusTreeView: {
    description: 'Automatically focus the tree view when it is opened to enable keybindings on the tree view. Enabling this setting is known to cause issues where the tree view dialogs for adding/renaming files won\'t show, so disable if you\'re experiencing those issues.',
    type: 'boolean',
    default: true,
    order: 10,
  },
