...
import {isChildOf, addEventListener, addDelegatedEventListener} from './utils.js';
...
export function enableClickEvents() {
  ...
  disposables = new CompositeDisposable(
    ...
    addEventListener(treeViewEl, 'click', event => {
    ...
    addDelegatedEventListener(treeViewEl, 'click', ':not(.tree-view-scroller)', event => {
