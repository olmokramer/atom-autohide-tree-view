...
function disable() {
  ...
  update(true).then(show).then(function() {
    // finally dispose of the tree view and undefine all variables
    unregisterTreeView();
    [ enabledDisposable, focusedElement, currentSwipeEvent, currentAnimation ] = [];
  }).catch(logError);
}
...
function handleEvents() {
  ...
  enabledDisposable.add(treeViewEl, 'mouseenter', function onMouseEnter() {
