...
function init() {
  ...
  Promise.all([
    ...
    console.log(atom.packages.isPackageActive('atom-touch-events'), atom.packages.getActivePackage('atom-touch-events'));
...
function handleEvents(touchEvents) {
  // touch events
  if(touchEvents) {
    console.log(onTouchSwipeLeft(function() {
      console.log(arguments);
    }));

    console.log(onTouchSwipeRight(function() {
      console.log(arguments);
    }));
  }
