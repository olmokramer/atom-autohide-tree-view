...
var disposables, initialized = false;
...
module.exports = {
  ...
  deactivate: function deactivate() {
    ...
    if(this.touchSwipeLeftSubscription)
      this.touchSwipeLeftSubscription.dispose()
    if(this.touchSwipeRightSubscription)
      this.touchSwipeRightSubscription.dispose()
    deinit();
  },
  ...
  consumeTouchSwipeLeftService: function consumeTouchSwipeLeftService(onDidTouchSwipeLeft) {
    this.touchSwipeLeftSubscription = onDidTouchSwipeLeft(swipeChange, swipeEndLeft);
  },

  consumeTouchSwipeRightService: function consumeTouchSwipeRightService(onDidTouchSwipeRight) {
    this.touchSwipeRightSubscription = onDidTouchSwipeRight(swipeChange, swipeEndRight);
  }
};
