...
export const config = {
  ...
  hoverAreaSize: {
    description: 'Width of an invisible area at the edge of the screen where hover events will be triggered. When smaller than the value of the hiddenWidth setting, hiddenWidth will be used.',
    type: 'integer',
    default: 0,
    minimum: 0,
    order: 6
