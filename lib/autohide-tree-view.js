...
import { activateTreeView, getTreeView, getTreeViewEl, getContentWidth, logError, getConfig, setConfig, toggleConfig } from './utils.js';
...
function enable() {
  ...
  activateTreeView().then(function(treeViewPkg) {
...
function handleEvents() {
  ...
  disposables.add(atom.config.observe('autohide-tree-view.showOn', function(showOn) {
  ...
  disposables.add(getTreeView().list, 'blur', function onBlur() {
  ...
  disposables.add(getTreeViewEl(), 'click', '.entry.directory', function(event) {
