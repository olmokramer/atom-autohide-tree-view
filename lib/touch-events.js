...
import { autohideEnabled, showTreeView, hideTreeView } from './autohide-tree-view.js';

import { getTreeViewEl, getContentWidth, getConfig, isChildOf } from './utils.js';

var onDidTouchSwipeLeft, onDidTouchSwipeRight;
...
export {
  ...
  isEnabled as touchEventsEnabled
};
